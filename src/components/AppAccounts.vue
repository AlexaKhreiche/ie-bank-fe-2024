...
export default {
  ...
  methods: {
    ...
    initForm() {
      ...
      this.createAccountForm.country = ""; // Add this
      this.editAccountForm.id = "";
      this.editAccountForm.name = "";
      this.editAccountForm.country = ""; // Add this
    },
    ...
    onSubmit(e) {
      ...
      const payload = {
        ...
        country: this.createAccountForm.country, // Add this
      };
    ...
    onSubmitUpdate(e) {
      ...
      const payload = {
        ...
        country: this.editAccountForm.country, // Add this
      };
